...
#define READ16(buf, off) (PRUint16)buf[off] + ((PRUint16)buf[off+1] << 8)
#define READ32(buf, off) (PRUint32)buf[off] + ((PRUint32)buf[off+1] << 8) + ((PRUint32)buf[off+2] << 16) + ((PRUint32)buf[off+3] << 24)
